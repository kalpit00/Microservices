...
1. Backend - Spring Boot 3 + Kafka + Maven
2. Frontend - Angular
3. Deployment - Docker + Kubernetes
4. Security - KeyCloak for Oauth2.0

Project follows a complete industry grade approach

1. Four individual microservices : Product, Order, Inventory and Notification, which serve as Rest Endpoints or Kafka Templates
...
Complete project was containerized and Docker images were built, pushed to Docker Hub and deployed to K8s (Kind)
